...
public class  FormController {
    ...
    void back_button(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/com/example/demo2/ListEvent.fxml"));
...
//            s.initStyle(StageStyle.TRANSPARENT);
    ...
    void submit_action(ActionEvent event) {
        ...
        private void backToCardView(ActionEvent event) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/demo2/ListEvent.fxml"));
