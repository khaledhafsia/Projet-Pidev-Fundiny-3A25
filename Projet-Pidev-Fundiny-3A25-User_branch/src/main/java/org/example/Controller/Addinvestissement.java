...
public class Addinvestissement {
    ...
    public void initData(int idProjet) {
...
//                System.out.println("Payment successful. PaymentIntent ID: " + intent.getId());
                sp.add(new investissements(1, MyDataBase.getInstance().getIdenvoi(), idProjet, Double.parseDouble(tfmontant.getText()), tfdescription.getText(),currentTimestamp));
