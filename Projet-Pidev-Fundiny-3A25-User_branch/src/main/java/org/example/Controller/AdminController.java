...
//            adminControllerBlog controller = loader.getController();
    ...
    @FXML
    private void Proj(ActionEvent event) {
        try {
    ...
    public void affchbackinv(ActionEvent actionEvent) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/showinvBack.fxml"));
            Parent root = loader.load();

          ShowinvBack controller = loader.getController();
