...
public class AfficherProjetUserController implements Initializable {
...
//        filterField.getScene().setRoot(my_root);
    ...
    private VBox createProjetNode(Projet projet) throws IOException {
        ...
        collaborer.setOnAction(event -> {
            try {
                ...
                collaborerProjetController.setAfficherProjetUserController(this);
    ...
    public void affichage() {
        ...
        try {
            ...
            List<Projet> lv = sp.getProjectsByUserId(MyDataBase.getInstance().getIdenvoi());
            ...
            Logger.getLogger(AfficherProjetUserController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
