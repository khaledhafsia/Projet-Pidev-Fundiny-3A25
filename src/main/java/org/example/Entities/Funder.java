...
public class Funder extends User{
    ...
    public Funder(int nom, String prenom, String telephone, String adresse, String email, User.role password, float participation) {
...
/*
    ...
    public Funder(int id, String nom, String prenom ,String email, String password, float participation) {
