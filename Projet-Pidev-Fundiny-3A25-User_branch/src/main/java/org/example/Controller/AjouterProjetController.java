...
public class AjouterProjetController implements Initializable {
    ...
    void Ajouter(ActionEvent event) throws SQLException {
        if (InputValidator.validateFields(nomPrT, nomPoT, dateDT, CAT)) {
            ...
            System.out.println(nomPrT.getText());
                sp.add(new Projet(1, MyDataBase.getInstance().getIdenvoi(), nomPrT.getText(), nomPoT.getText(), sqlDate, Integer.parseInt(CAT.getText())));
    ...
    void Afficher(MouseEvent event)throws IOException {
        try {
            ...
            System.out.println("FXML file path: " + getClass().getResource("/AfficherProjetUser.fxml"));
            e.printStackTrace();
        }
